...
<body>
    ...
    <div class="form_com">
        <h2 class="jolie">Ecrivez-nous un jolie commentaire !</h2>
    <form method="POST" action="commentaire_treatment.php">
        <textarea class="texte" name="commentaire" required></textarea><br>
        <input type="submit" id="btn" name="submit" value="Envoyer">
    </form>
    </div>
</body>
